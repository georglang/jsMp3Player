...
define('dragableItem',['jQuery'], function($) {
...
define('views/playerControlsView',['jQuery', 'views/playerControlsView'], function($) {
...
;
define('views/timelineView',['jQuery', 'slider'], function($, components) {
...
define('views/tracklistView',['jQuery', 'views/tracklistView'], function($) {
...
define('views/trackInfoView',['jQuery','views/trackInfoView'], function($) {
...
define('views/volumeSliderView',['jQuery', 'slider'], function($, components) {
