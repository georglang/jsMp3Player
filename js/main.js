...
require([
  ...
  'controller',
  'dragableItem',
  'views/playerControlsView',
  'views/timelineView',
  'views/tracklistView',
  'views/trackInfoView',
  'views/volumeSliderView'
], function ($, PlayerModel, PlayerController, DragableItem, PlayerControlsView, TimelineView, TracklistView, TrackInfoView, VolumeSlider) {
